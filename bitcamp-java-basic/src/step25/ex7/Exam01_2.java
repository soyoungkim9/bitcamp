// 트랜잭션(Transaction) 다루기 - 수동으로 commit 하기
package step25.ex7;
...
public class Exam01_2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 명시적으로 commit을 요청하기 전에는 테이블에 그 결과를 적용하지 않는다.
        // commit을 요청하기 전에 수행한 데이터를 모든 작업은(insert|update|delete)
        // DBMS의 임시 테이블에 보관된다.
        ...
        // 임시 저장소에 보관된 작업 결과(insert|update|delete)를
        // 실제 테이블에 적용한다.
        con.commit();
