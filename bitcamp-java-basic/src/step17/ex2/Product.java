...
public class Product {
    ...
    public static final int COMPUTER_POET = 100;
    public static final int COMPUTER_NOVEL = 101;
    public static final int COMPUTER_ESSAY = 102;
    public static final int COMPUTER_IT = 103;
    public static final int COMPUTER_LANG = 104;
