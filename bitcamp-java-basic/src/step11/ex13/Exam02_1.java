...
public class Exam02_1 extends C{
    ...
    public static void main(String[] args) {
        ...
        // obj1.protectedVar = 100; // 접근 불가! 오직 그 클래스 안에서만 사용가능.
        obj1.defaultVar = 100; // OK! 이 클래스는  A 클래스와 같은 패키지와 소속되어 있다.
        ...
        // obj2.defaultVar = 100; // 접근불가!
        // obj2.protectedVar = 100; // 접근불가!
        obj2.publicVar = 100; // OK! 모두 다 접근 가능.
        
        C obj3 = new C();
        
        // obj3.privateVar = 100; // 접근 불가!
        // obj3.defaultVar = 100; // 접근불가!
        // obj3.protectedVar = 100; // 접근불가!
                                 // 자식 클래스인데 접근 불가?
                                 // 이유 => 자기의 인스턴스 변수가 아니다.
