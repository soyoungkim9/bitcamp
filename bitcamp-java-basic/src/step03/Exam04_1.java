...
// - 이유?
//   Exam04_1.java에서 Source 클래스를 사용하는데
//   컴파일할 때 Source클래스 정보가 필요하다.
...
//
//   방법2) Score 클래스의 파일이 있다면 소스 파일의 위치를 알려줘라.
//      > javac -encoding UTF-8 -d -sourcepath src /src/step03/Exam04_1.java
