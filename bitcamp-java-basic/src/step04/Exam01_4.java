...
public class Exam01_4 {
    public static void main(String[] args) {
        int i = 5;
        int j = 2;
        float r = i / j; // int의 연산 결과는 항상 int이다.
                                // 따라서 r변수에 넣기 전에
                                // 이미 결과는 정수 2가 된다.
                                // 정수 2를 float 변수에 넣으면
                                // 출력할 때 2.0이 된다.
        ...
        int r1 = x + y; // 0x7fffffff + 0x7fffffff = 0x7fffffff2 = -2
        long r2 = x + y; // 0x7fffffff
...
// - 즉, 연산 결과는 피연자의 타입과 같다.
// - 그래서 두값을 계산했을 때 메모리를 초과할 경우에
//   값이 짤릴 수 있다.
