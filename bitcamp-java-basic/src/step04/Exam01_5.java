...
public class Exam01_5 {
    public static void main(String[] args) {
        ...
        // byte + short = int
        // byte와 short값은 int 암시적형변환 된다.
        // short r3 = b + s; // 컴파일 오류!

        // byte + int = int
        // => byte가 int로 형변환 한 이후 연산을 수행한다.
        int r4 = b + i; // OK

        // short + int = int
        // => short가 int로 암시적 형변환 한 이후에 연산을 수행한다.
        int r5 = b + i; // OK
        ...
        // boolean + int = 컴파일 오류!
        // => 산술 연산자는 정수 타입과(short, byte, char, int, long)
        //    과 부동소수점(float, double) 타입에 대해서만
        // 실행할 수 있다.
