...
// - JVM을 종료하면 어차피 운영체제에게 사용한 메모리를 반납해야 하기 때문에
//   자동으로 해제된다.
// - 그러나 JVM이 실행하는 중에 개발자가 임의로 해제할 수 없다.
// - 오직 가비지 컬렉터(garbage collector)만이 가비지를 해체할 수 있다.
