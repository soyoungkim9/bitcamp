// 요청 핸들러의 파라미터 - custom property editor 등록하기 I
...
public class Exam05_4 {
    ...
    // 프론트 컨트롤러가 페이지 컨트롤러를 호출 할 때 기본적으로
    ...
    // 문자열로 넘어온 값을 커스텀 프로퍼티 에디터를 통해 Member 객체로 받는다.
    // 단 파라미터 타입 앞에 @RequestParam을 반드시 붙여야 한다.
    // 테스트:
    // http://localhost:8888/bitcamp-spring-webmvc/mvc/exam05_4/m2?member=hong,test@test.com,1111
    @GetMapping(value="m2")
    @ResponseBody 
